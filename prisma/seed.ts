...
async function main() {
  ...
  // Services
  const services = [
    { title: 'Web Development', slug: 'web-development', icon: 'Code2', description: 'High-performance websites & web apps engineered with Next.js, TypeScript, and modern infrastructure. Pixel-perfect, blazing-fast, built to scale.', features: ['Next.js & React', 'Type-safe architecture', 'Edge & serverless', 'Core Web Vitals optimized'] },
  ...
  const projects = [
    {
      ...
      solution: 'We built a custom Next.js site with a bespoke headless CMS, project management admin panel, and transactional email integration — all wrapped in a cinematic, editorial design system.',
      ...
      tags: JSON.stringify(['Next.js', 'Custom CMS', 'Email Integration', 'Admin Panel']),
      featured: true,
      order: 0,
    },
    {
    ...
    },
    {
      ...
      solution: 'New identity system paired with a performant Next.js site and integrated booking flow.',
      result: 'Direct bookings increased 58% post-launch.',
      image: '/uploads/tides.jpg',
      tags: JSON.stringify(['Branding', 'Next.js', 'Booking']),
      featured: false,
      order: 3,
    },
  ]
